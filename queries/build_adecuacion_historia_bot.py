...
(camp5588.json, camp6126.json, camp6816.json, c7360.json) -- no pega a EOC de
nuevo, son datos ya confirmados en el dashboard. Genera un NDJSON para bq load.

Uso:
    python3 queries/build_adecuacion_historia_bot.py > /tmp/adecuacion_historia.ndjson
    bq load --source_format=NEWLINE_DELIMITED_JSON \
        SBOX_CREDITSSIGMA.NB619_ADECUACION_HISTORIA_BOT \
...
SOURCES = [
    ...
    ("c7360.json", "Sep-26", 2960, "202609-MLB-IND-TC-FULL-UPSELL-TEST COMBINADO-RENTA-ADECUACION-PS-1"),
]
